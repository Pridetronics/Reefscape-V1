...
public class CollectAlgaeLow extends SequentialCommandGroup {
  /** Creates a new CollectAlgae. */
  public CollectAlgaeLow(ManipulatorSubsystem manipulatorSubsystem, IntakeSubsystem intakeSubsystem) {
